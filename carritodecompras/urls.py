...
from .views import ver_carrito, agregar_al_carrito, eliminar_producto, ver_carrito_sesion, agregar_producto_sesion, eliminar_producto_sesion, procesar_pago_stripe, procesar_pago_mp, actualizar_contacto_pedido, incrementar_cantidad_producto, disminuir_cantidad_producto
...
urlpatterns = [
    ...
    path('incrementar/<int:producto_id>/', incrementar_cantidad_producto, name='incrementar_cantidad_producto'),
    path('disminuir/<int:producto_id>/', disminuir_cantidad_producto, name='disminuir_cantidad_producto'),
